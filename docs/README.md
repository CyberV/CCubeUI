...
| [`06-additional-insights.md`](./06-additional-insights.md) | Gap-fill doc: asset shapes, storage keys, hard-coded config, routing quirks, and design notes for Offline Mode + N6/N7/N8 |
